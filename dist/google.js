...
export function createGoogleVerifier(deps, config) {
    ...
    async function verify(idToken) {
        ...
        try {
            ...
            throw new AuthKitError("jwks_failure", "JwksSource.getKeys failed while verifying a Google id_token", { cause });
        }
        ...
        return {
            ...
            identity: {
                ...
                emailVerified: true,
                displayName: payload.name !== undefined && payload.name !== null
                    ? String(payload.name)
                    : undefined,
            },
        };
