    ...
    async refresh() {
        ...
        try {
            ...
            try {
                ...
                throw new AuthKitError("jwks_failure", `JWKS response from ${this.url} was not valid JSON`, { cause });
            }
        }
        finally {
        ...
        if (keys === null) {
            throw new AuthKitError("jwks_failure", `JWKS response from ${this.url} did not contain a "keys" array`);
        }
...
//# sourceMappingURL=jwks-fetch.js.map